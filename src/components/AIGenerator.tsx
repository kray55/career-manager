  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-xl p-6">
      ...
      <button onClick={handleGenerate} disabled={isGenerating}
        ...
        {isGenerating ? (
          <>
            <svg className="animate-spin h-4 w-4" viewBox="  24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" fill="none" /><path className="opacity-75" fill="currentColor" d="M4 12a8 8  018-8VC5.373   5.373  12h4zm2 5.291A7.962 7.962  014 12Hc 3.042 1.135 5.824 3 7.938l3-2.647z" /></svg>
            Generating...
          </>
        ) : (
          <>
