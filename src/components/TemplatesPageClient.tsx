...
const TEMPLATES: Template[] = [
  {
    ...
    color: "green",
    content: "<h1>Your Name</h1><p>Email | Phone | Location | LinkedIn</p><hr/><h2>Professional Summary</h2><p>A brief summary of your experience and career goals...</p><h2>Experience</h2><h3>Job Title — Company Name</h3><p><em>Month YYYY – Present | Location</em></p><ul><li>Key accomplishment with metrics</li><li>Key responsibility or achievement</li></ul><h2>Education</h2><h3>Degree — University Name</h3><p><em>Graduation Year</em></p><h2>Skills</h2><p>Skill 1, Skill 2, Skill 3, Skill 4</p>",
  },
  {
    id: "resume-creative",
    ...
    icon: "M10 6H5a2 2 00-2 2v9a2 2 002 2h14a2 2 002-2V8a2 2 00-2-2h-5m-4 V5a2 2 00-2-2H8a2 2 00-2 2v1m4 a2 2 00-2-2H8a2 2 00-2 2v1m4 a2 2 00-2-2H8a2 2 00-2 2m10 4h-4m h-4m4 v4m-4h4",
    color: "purple",
    content: "<h1 style='color: #7c3aed;'>YOUR NAME</h1><div style='background: #f5f3ff; padding: 1rem; border-radius: 8px;'><p>Email | Phone | Portfolio</p></div><hr/><h2 style='color: #7c3aed;'>Experience</h2><h3>Creative Role — Agency</h3><ul><li>Showcase your creative achievements</li></ul><h2 style='color: #7c3aed;'>Skills</h2><p>Creative Direction, Design Thinking, Figma, Adobe Suite</p>",
  },
  {
    ...
    color: "blue",
    content: "<h2>Your Name</h2><p>Email | Phone | Location</p><p>Date</p><hr/><h3>Hiring Manager</h3><p>Company Name</p><p>Company Address</p><br/><p>Dear Hiring Manager,</p><br/><p>I am writing to express my strong interest in the <strong>[Job Title]</strong> position at <strong>[Company Name]</strong>. With my background in [Your Field] and [X] years of experience...</p><br/><p>[Paragraph 2: Highlight key achievements and why you're a good fit]</p><br/><p>[Paragraph 3: Show enthusiasm for the company/role]</p><br/><p>Sincerely,</p><p>Your Name</p>",
  },
  {
    ...
    icon: "M3 8l7.89 5.26a2 2 01  2.96L3 20V8z M3 8l7.89-5.26a2 2 01 -2.96L3 8z",
    color: "indigo",
    content: "<h2>Your Name</h2><p>Email | Phone</p><hr/><p>Dear <strong>[Company Name]</strong> team,</p><br/><p>I'm excited to apply for the <strong>[Job Title]</strong> role. I bring [X] years of experience in [Your Field] and a proven track record of [Key Achievement].</p><br/><p>I'm particularly drawn to [Company Name] because [Reason]. I believe my skills in [Skill 1], [Skill 2], and [Skill 3] align perfectly with what you're looking for.</p><br/><p>I'd love to discuss how I can contribute to your team.</p><br/><p>Best regards,<br/>Your Name</p>",
  },
  {
    id: "document-general",
  ...
  },
  {
    ...
    icon: "M9 12h6m-6 4h6m2 5H7a2 2 01-2-2V5a2 2 012-2h5.586a1 1 01.707.293l5.414 5.414a1 1 01.293.707V19a2 2 01-2 2z",
    color: "teal",
    content: "<h2>Subject: Thank You — [Job Title] Interview</h2><hr/><p>Dear [Interviewer Name],</p><br/><p>Thank you so much for taking the time to meet with me today to discuss the <strong>[Job Title]</strong> position at <strong>[Company Name]</strong>.</p><br/><p>I really enjoyed learning more about [Something specific you discussed]. It reinforced my enthusiasm for the role and the work your team is doing.</p><br/><p>I'm confident that my experience in [Your Field] would allow me to hit the ground running and contribute immediately.</p><br/><p>Please don't hesitate to reach out if you need any additional information.</p><br/><p>Best regards,</p><p>Your Name</p><p>[Email] | [Phone]</p>",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {selectedTemplate && (
          <div className="fixed inset- bg-black/60 z-50 flex items-center justify-center p-4"
            onClick={() => setSelectedTemplate(null)}>
            <div className="bg-slate-900 border border-white/10 rounded-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto"
              onClick={e => e.stopPropagation()}>
              <div className="sticky top- bg-slate-900 border-b border-white/10 px-6 py-4 flex items-center justify-between">
