...
export default function DashboardView({ user, stats }: Props) {
  ...
  const menus = [
    ...
    { label: "Build", items: [["/notes", "Notes", "Turn research into action"], ["/documents", "Documents", "Organize your career files"], ["/document-workspace", "Full Document Workspace", "Manage long reports and publications"], ["/templates", "Templates", "Start from a proven format"]] },
